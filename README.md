...
- To add additional authors: Manually add a photo of your new author. **The picture will need to be exactly 1080px x 1350px in dimensons** Then edit the `authorGenerator.py` file to append your new author to the list of possible authors the application will choose from.
